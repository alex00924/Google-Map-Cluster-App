...
public class IconStyle {
    ...
    private final int clusterBackgroundColor_Same;
    ...
    private IconStyle(@NonNull Builder builder) {
        ...
        clusterBackgroundColor_Same = builder.clusterBackgroundColor_Same;
     ...
     */
    @ColorInt
    public int getClusterBackgroundColor(boolean bSamePlace) {
        if( bSamePlace )
            return clusterBackgroundColor_Same;
    ...
    public static class Builder {
        ...
        private int clusterBackgroundColor_Same;
        ...
        public Builder(@NonNull Context context)  {
            ...
            clusterBackgroundColor_Same = ContextCompat.getColor(
                    context, R.color.cluster_background_same);
            ...
            clusterBackgroundColor += 10 * RANDOM.nextDouble();
        }
